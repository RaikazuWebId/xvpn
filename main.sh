...
CEKEXPIRED() {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/RaikazuWebId/izinsc/main/ip | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
echo "Akses di tolak!! Makan Tuh di Tolak!!";
exit 0
fi
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/RAIKAZUSTORE"},{"text":"Contack","url":"wa.me/+6282164649858"}]]}'
...
rm -rf bot.sh && wget https://raw.githubusercontent.com/RaikazuWebId/vpnscript/refs/heads/mytich/bot/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn
}
function profile(){
clear
